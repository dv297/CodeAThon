...
public class AddItemActivity extends Activity {
	...
	public void addItemSubmissionClick(View view){
		EditText addItemEditText = (EditText) R.findViewById(R.id.addItemEditText);
		EditText addLocationEditText = (EditText) R.findViewById(R.id.addLocationEditText);
		EditText addKeywordsEditText = (EditText) R.findViewById(R.id.addKeywordsEditText);
